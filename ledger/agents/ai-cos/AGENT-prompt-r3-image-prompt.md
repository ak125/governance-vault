---
agent_id: prompt.r3-image-prompt
agent_name: Image Prompt (R3)
status: active
owner: SEO Team
...
# Agent: Image Prompt (R3)

## Identity

| Field | Value |
|-------|-------|
| ID | `prompt.r3-image-prompt` |
| Name | Image Prompt (R3) |
| Status | active |
| Owner | SEO Team |
| Description | Generation de prompts image pour illustrations gammes R3 |
...
- **Read**: __seo_gamme_purchase_guide, product images
- **Write**: Image prompts (report_only)
