---
agent_id: prompt.r4-keyword-planner
agent_name: Keyword Planner (R4)
status: active
owner: SEO Team
...
# Agent: Keyword Planner (R4)

## Identity

| Field | Value |
|-------|-------|
| ID | `prompt.r4-keyword-planner` |
| Name | Keyword Planner (R4) |
| Status | active |
| Owner | SEO Team |
| Description | Keyword planning pour pages R4 (references auto) |
...
- **Write**: __seo_r4_keyword_plan (via RPC)
