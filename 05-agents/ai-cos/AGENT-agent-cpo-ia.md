...
| Owner | AI-COS Architecture Team |
| Description | Chief Product Officer - Product strategy and roadmap |
...
| Risk Class | **HIGH** |
| Risk Factors | Product decisions, feature prioritization |

## Access Rights

- **Read**: monorepo (full), governance-vault (full), analytics
