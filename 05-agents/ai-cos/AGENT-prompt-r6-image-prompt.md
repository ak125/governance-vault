---
agent_id: prompt.r6-image-prompt
agent_name: Image Prompt (R6)
status: active
owner: SEO Team
...
# Agent: Image Prompt (R6)

## Identity

| Field | Value |
|-------|-------|
| ID | `prompt.r6-image-prompt` |
| Name | Image Prompt (R6) |
| Status | active |
| Owner | SEO Team |
| Description | Generation de prompts image pour illustrations guides R6 |
...
- **Read**: Guide content, product images
