...
| 2026-05-06 | [[2026-05-06-r3-cleanup-canon-shipped]] | R3 cleanup grid — 3 PRs monorepo (#330 P0 admin labels mergée, #335 P3 Phase 1 backend `@deprecated`, #336 P1 docs SEO batch) + vault PR #173 (ADR-044 plan 3-phases rename `R3GuideController` → `R3ConseilsController`). Étend ADR-040 sans nouvelle décision architecturale. P2 helper local refusé (canon couvre déjà). Phase 2 (rename + cohabitation alias) trigger 2026-06-05 (T0+30j) ; Phase 3 (drop alias) trigger 2026-07-05 sur condition `0 req /7d`. Renumber forcé 043 → 044 (collision concurrente avec PR vault #174 Plan F DevSecOps). Régression CWV +7KB de PR #330 acceptée à l'admin-merge ; cleanup follow-up identifié hors scope. Worktree obligatoire appliqué après collision concurrent agent en PR #330. |
