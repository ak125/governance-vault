...
| 2026-04-30 | [[2026-04-30-session-repivot-option-c-to-d]] | Session-trail (audit utilisateur 6 points → 3 itérations plan rev1/2/3 → repivot ADR-028 Option C Supabase branch $9.66/mois → Option D read-only hardening $0/mois ; vault PR #111 closed pour scope mixing ; 2 mémoires updated) |
