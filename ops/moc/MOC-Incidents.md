...
| [[2026-04-25-503-vehicle-build-payload-slow\|INC-2026-010]] | 2026-04-25 | Medium | 503 R8 vehicle pages — build_vehicle_page_payload sous-requete catalog mal optimisee (Phase 1 ADR-016). Fix root-cause CTE 2-phases + steady-state guarantees (cron + trigger + canon). | Resolved (pending merge PR #167 + vault #65) |
