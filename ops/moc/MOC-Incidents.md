...
|----|------|----------|-------|--------|
| [[2026-08-14-env-test-template-production-secrets|INC-2026-017]] | 2026-08-14 | Critical | Secrets de production publies via un faux template de test (backend/.env.test.template tracke au HEAD, depot public). RETRACTE le verdict SEC-03 du 2026-08-13. SESSION_SECRET tourne sur DEV ; PROD/PREPROD, SystemPay PROD+TEST, Resend et Paybox ouverts. Famille JWT legacy Supabase revoquee (control-plane). | Investigating |
