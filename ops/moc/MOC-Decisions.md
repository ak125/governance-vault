...
| ADR-050 | Quality history & drift detection — `__seo_quality_history` + RPC outliers + Sentry/OTel enrichers (Phase 0 baseline, prérequis bloquant PR-T) | Proposed | 2026-05-07 | [[ADR-050-quality-history-and-drift-detection]] |
