...
| ADR-051 | SQL role canon deprecation — defer to TS-only canon (ADR-040), evidence-pack Supabase prouve migration `20260124_add_page_role.sql` jamais appliquée en prod | Proposed | 2026-05-08 | [[ADR-051-sql-role-canon-deprecation]] |
