...
> **Notes** :
> - **ADR-026, ADR-027** sont en cours sur leurs propres feature branches respectives (`docs/adr-026-content-separation`, `adr/027-r5-consolidation-r3-s2-diag`). Elles seront ajoutées ici quand leurs PRs respectives seront mergées sur main.
